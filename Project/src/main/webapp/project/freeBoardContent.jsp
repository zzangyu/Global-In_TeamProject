					...
					<div class="spot-contents">
						<div id="note_panel">
							...
							<span class="boardname">공지</span>
								...
								<div class="right">
								<!-- 리스트 버튼 -->
								<button class="listBtn" onclick="document.location.href='cityPlan.do?cmd=freeBoardList&pageNum=${pageNum }'"><img src="images/list.png" width="24px" height="24px"></button>
								...
								<!-- 업데이트 모달 -->
									...
									<div class="umodal hidden">
  											...
  											<div class="umBox">
	     										<div class='umodal_dialog'>
       		 										<div class='umodal_contents'>
         	   											<form action="cityPlan.do?cmd=freeBoardUpdateProc" method="post" name="updateForm">
										...
										<c:if test="${loginID == article.writer }">
										<button id="deleteBtn">
										<img src="images/delete.png" width="24px" height="24px" onclick="document.location.href='cityPlan.do?cmd=freeBoardDeleteProc&num=${article.num }&pageNum=${pageNum }'">
										</button>
										</c:if>
							...
							<div class="conts-label">
								<div class="spot-like-count">
									<a>좋아요
									<input type="button" onclick="location.href='cityPlan.do?cmd=freeEvaluation&gechu=1&bichu=0&num=${num}'" value="${gechu}">
									</a>
							...
							<div class="plan-comment">
								<div class="spot-comment-content">
									<div class="comment-write">
										<form method="post" enctype="multipart/form-data" action="cityPlan.do?cmd=freeComment&num=${num }" name="commentInputForm" onsubmit="return checkText()">
									...
									<div class="comment-contents">
										...
										<div class="edit-delete">
											<c:if test="${list.userID eq loginID }">
														<form name = "p_search">
															<a type="button" onclick="fnwindow(${num },${list.commentID })">수정</a>
														</form>	
														<a onclick="return confirm('정말로 삭제하시겠습니까?')" href = "cityPlan.do?cmd=freeCommentDelete&num=${num }&commentID=${list.commentID }">삭제</a>
												</c:if>
										</div>
