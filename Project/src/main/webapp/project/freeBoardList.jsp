  ...
  <div class="bg"></div>
  	<div class="mBox">
	     <div class='modal-dialog'>
         	   ...
         	   <form action="cityPlan.do?cmd=freeBoardWriteProc" method="post" name="writeForm" onsubmit="return writeSave()">
...
<c:if test="${count>0 }">
 ...
 <c:forEach var="article" items="${articleList }">
   ...
   <a href = "cityPlan.do?cmd=freeBoardContent&num=${article.num }&pageNum=${currentPage}">
  ${article.subject}
  </a>
  </h4>
...
<div class="paging">
 ...
 <c:if test="${startPage > pageBlock}">
   <a class="btn-prev" href="cityPlan.do?cmd=freeBoardList&pageNum=${startPage - pageBlock }">이전</a>
 </c:if>
 ...
 <c:forEach var="i" begin="${startPage }" end="${endPage }"><li>
   <a class="active" href="cityPlan.do?cmd=freeBoardList&pageNum=${i }">${i }</a></li>
 </c:forEach>
	...
	<c:if test="${endPage < pageCount }">
    <a class="btn-next" href="cityPlan.do?cmd=freeBoardList&pageNum=${startPage + pageBlock }">다음</a>
	</c:if>
